...
{
		public static final String[] STOP_WORD_VALUES = new String[] {"php","zip","png","www","html","htm","asp","gif","jpg","svg","pdf","place","feature","geo","owl","yago","entity","thing","object","maps","map", "contents", "hide", "history", "geography", "demographics",
																	   "arts and culture", "notable people", "climate", "references", 
